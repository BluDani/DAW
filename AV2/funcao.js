function ListarCandidatos(){
    ...
    console.log("4");
    xmlhttp.open("GET", "http://localhost/DAW/AV2/listarCandidato.php");
...
function InserirCandidato(){
    ...
    xmlhttp.open("POST", "http://localhost/DAW/AV2/adicionarCandidato.php");
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function AlterarSala(){
    ...
    xmlhttp.open("POST", "http://localhost/DAW/AV2/alterarSala.php");
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function InserirFiscal(){
    ...
    let cpf = document.getElementById("cp_fiscal").value;
